CREATE TABLE hr.locations (
  ...
  "BY" VARCHAR2(30 BYTE) NOT NULL CONSTRAINT loc_city_nn CHECK ("BY" IS NOT NULL),
...
of a company. ';
COMMENT ON COLUMN hr.locations."BY" IS 'A not null column that shows city where an office, warehouse, or
